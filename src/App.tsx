...
function BG({n,alt,src}:{n?:number;alt?:boolean;src?:string}){
  return <div className={`slide__bg${alt?' slide__bg--alt':''}`}><img src={src||I[n!]} alt=""/></div>;
}
...
/* SLIDE 1 — Title / Cover (CORRECTED: EmpowaYouth, date, time, removed Creative Futures Africa Summit) */
...
<div className="cnt cnt--right"><motion.div initial="hidden" animate="visible">
  ...
  <h2 className="ttl ttl--lg"><W t="African Creative"/><span className="accent"><W t="Economy"/></span></h2>
  <motion.p variants={fu(.7)} className="sub">A 2025 summit convened in Johannesburg identified 3 converging dynamics reshaping Africa's creative sector.</motion.p>
</motion.div></div></div>);}
...
/* SLIDE 5 — DELETED (was "Under 20 — Africa's Median Ages") */

/* SLIDE 6 — Context / Unprecedented Potential (now slide 5 in deck) */
...
/* SLIDE 7 — Breaking Into the Industry (no changes) */
...
/* SLIDE 8 — Camera Operations / Production (badge--section applied) */
...
/* SLIDE 9 — Core Technical Skills / Writing (CORRECTED: "3-act structure" → "structure", badge--section) */
...
<div className="cnt cnt--right"><motion.div initial="hidden" animate="visible">
  ...
  <motion.p variants={fu(.6)} className="sub">Screenplay format, structure, dialogue, pitching.</motion.p>
</motion.div></div></div>);}

/* SLIDE 10 — Core Technical Skills / Sound (badge--section applied) */
...
/* SLIDE 11 — Art / Design Department (badge--section applied) */
...
/* SLIDE 12 — Post-Production / DaVinci Resolve (no content changes, badge--section) */
...
<div className="cnt cnt--right"><motion.div initial="hidden" animate="visible">
  <motion.div variants={fu(.1)}><span className="badge badge--section">Storytelling</span></motion.div>
  <h2 className="ttl ttl--lg"><W t="Visual"/><span className="accent"><W t="Literacy"/></span></h2>
  <motion.p variants={fu(.6)} className="sub">Understanding shot composition, framing, camera angles — close-up vs wide.</motion.p>
</motion.div></div></div>);}

/* SLIDE 14 — Storytelling / Story Structure (badge--section) */
...
/* SLIDE 15 — Storytelling / Observation (badge--section) */
...
/* SLIDE 16 — Soft Skills / Reliability (badge--section) */
function S16({a}:P){if(!a)return null;return(<div className="slide"><BG n={16} alt/><div className="ov ov--r"/>
<div className="cnt cnt--right"><motion.div initial="hidden" animate="visible">
  <motion.div variants={fu(.1)}><span className="badge badge--section">Soft Skills</span></motion.div>
...
/* SLIDE 17 — Soft Skills / Collaboration (badge--section) */
...
/* SLIDE 18 — Soft Skills / Communication (badge--section) */
...
/* SLIDE 19 — Soft Skills / Resilience (badge--section) */
...
/* SLIDE 20 — Soft Skills / Problem Solving (badge--section) */
...
/* SLIDE 21 — Set Roles (CORRECTED: DIT/AD written in full, 5+ Key Set Roles white+bold, badge--section) */
...
<div className="cnt cnt--left"><motion.div initial="hidden" animate="visible">
  <motion.div variants={fu(.1)}><span className="badge badge--section">Industry Knowledge</span></motion.div>
  <h2 className="ttl ttl--lg"><W t="Set"/><span className="accent"><W t="Roles"/></span></h2>
  <motion.p variants={fu(.6)} className="sub">Know what a 1st Assistant Director (AD), gaffer, Digital Imaging Technician (DIT), script supervisor actually do.</motion.p>
  <motion.p variants={fu(.9)} className="sub" style={{fontWeight:700,color:'var(--white)'}}>5+ Key Set Roles</motion.p>
</motion.div></div></div>);}

/* SLIDE 22 — Workflow (badge--section) */
...
/* SLIDE 23 — SA Context (CORRECTED: removed B-BBEE, added "Understand Key Stakeholders", badge--section) */
...
<div className="cnt cnt--left"><motion.div initial="hidden" animate="visible">
  ...
  <motion.p variants={fu(.6)} className="sub">Understand Key Stakeholders, NFVF funding, who the big production companies are in Joburg/Cape Town.</motion.p>
</motion.div></div></div>);}

/* SLIDE 24 — Safety (no content changes, badge--section) */
...
/* SLIDE 25 — Short Courses (CORRECTED: removed "Big Fish School of Digital Filmmaking", badge--section) */
function S25({a}:P){if(!a)return null;return(<div className="slide"><BG n={25}/><div className="ov ov--r"/>
<div className="cnt cnt--right"><motion.div initial="hidden" animate="visible">
  <motion.div variants={fu(.1)}><span className="badge badge--section">Build Your Toolkit</span></motion.div>
  <h2 className="ttl ttl--lg"><W t="Short"/><span className="accent"><W t="Courses"/></span></h2>
  <motion.p variants={fu(.6)} className="sub">AFDA, CityVarsity, Wits Film & TV offer 6-week to 1-year intro courses.</motion.p>
</motion.div></div></div>);}

/* SLIDE 26 — Run on Set (CORRECTED: "PA/runner" → "Production Assistant / Runner", badge--section) */
...
<div className="cnt cnt--right"><motion.div initial="hidden" animate="visible">
  ...
  <motion.p variants={fu(.6)} className="sub">Volunteer as a Production Assistant / Runner. You'll learn everything by watching + doing.</motion.p>
</motion.div></div></div>);}

/* SLIDE 27 — Make Stuff (CORRECTED: removed certificates, 3 clear action points, badge--section) */
...
<div className="cnt cnt--right"><motion.div initial="hidden" animate="visible">
  ...
  <motion.p variants={fu(.6)} className="sub">Join the SA Film Industry Facebook groups, go to DIFF/Durban FilmMart, Industry Initiatives.</motion.p>
</motion.div></div></div>);}

/* SLIDE 29 — Software Skills (CORRECTED: "Celtx" → "softwares for writing", badge--section) */
...
<div className="cnt cnt--right"><motion.div initial="hidden" animate="visible">
  ...
  <motion.p variants={fu(.6)} className="sub">Get comfortable with softwares for writing, DaVinci Resolve (free) for editing, Zoom recorders for sound.</motion.p>
</motion.div></div></div>);}

/* SLIDE 30 — Entry Points (no changes) */
...
/* SLIDE 31 — Training vs Experience (CORRECTED: badge--section, added "Training helps with craft / skill") */
...
<div className="cnt cnt--center"><motion.div initial="hidden" animate="visible" style={{textAlign:'center'}}>
  <motion.div variants={fu(.1)}><span className="badge badge--section">Training vs Experience</span></motion.div>
  ...
  <motion.p variants={fu(.9)} className="sub" style={{margin:'0.5rem auto',textAlign:'center',fontWeight:700,color:'var(--white)'}}>Training helps with craft / skill</motion.p>
</motion.div></div></div>);}

/* SLIDE 32 — Training vs Experience Table (no changes) */
...
/* SLIDE 33 — No Certificate on Set (badge--section for Industry Reality) */
...
<div className="cnt cnt--bottom"><motion.div initial="hidden" animate="visible">
  <motion.div variants={fu(.1)}><span className="badge badge--section">Industry Reality</span></motion.div>
...
/* SLIDE 34 — Apprenticeship Over Diplomas (badge--section for Industry Reality) */
...
/* SLIDE 35 — Training Helps With Craft */
...
/* SLIDE 37 — Runner / PA (CORRECTED: removed named production companies) */
function S37({a}:P){if(!a)return null;return(<div className="slide"><BG n={37}/><div className="ov ov--r"/>
<div className="cnt cnt--right"><motion.div initial="hidden" animate="visible">
  <motion.div variants={fu(.1)}><span className="badge badge--section">Entry Jobs</span></motion.div>
  <h2 className="ttl ttl--lg"><W t="Runner /"/><span className="accent"><W t="PA"/></span></h2>
  <motion.p variants={fu(.6)} className="sub">Coffee, lockups, driving, wrangling extras. You see every department. Email Joburg production houses. Say "Available for free 2 weeks".</motion.p>
</motion.div></div></div>);}

/* SLIDE 38 — Camera Trainee (badge--section) */
...
/* SLIDE 39 — Art Department Assistant (badge--section) */
...
/* SLIDE 42 — Don't Just Study (NOTE: "Yanga" not found in codebase — no change needed) */
...
<div className="cnt cnt--right"><motion.div initial="hidden" animate="visible">
  ...
  <motion.p variants={fu(.6)} className="sub">Spending 3 years + debt on film school without doing any real practical work — You'll graduate but find yourself competing with younger people who have a portfolio of short films + commercials.</motion.p>
</motion.div></div></div>);}

/* SLIDE 43 — Bottom Line */
...
/* SLIDE 45 — Phone + Free Software (CORRECTED: removed "DaVinci Resolve is free" — duplicate) */
...
<div className="cnt cnt--right"><motion.div initial="hidden" animate="visible">
  ...
  <motion.p variants={fu(.6)} className="sub">Shoot a 1-min short every month. Post to TikTok/YouTube/Instagram. Producers scout there now.</motion.p>
</motion.div></div></div>);}

/* SLIDE 46 — 48 Hour Film Project (no changes) */
...
/* SLIDE 47 — Funding (CORRECTED: large heading, clean bulleted list, removed sentence) */
function S47({a}:P){if(!a)return null;return(<div className="slide"><BG n={47}/><div className="ov ov--r"/>
<div className="cnt cnt--right"><motion.div initial="hidden" animate="visible">
  <motion.div variants={fu(.1)}><span className="badge badge--section">Funding</span></motion.div>
  <motion.div variants={fu(.5)} style={{marginTop:'1.5rem',display:'flex',flexDirection:'column',gap:'0.8rem'}}>
    <motion.p variants={fu(.5)} className="sub" style={{fontWeight:700,color:'var(--white)',marginTop:0}}>• NFVF Funding</motion.p>
    <motion.p variants={fu(.6)} className="sub" style={{fontWeight:700,color:'var(--white)',marginTop:0}}>• Film Commissions</motion.p>
    <motion.p variants={fu(.7)} className="sub" style={{fontWeight:700,color:'var(--white)',marginTop:0}}>• NGO Funding</motion.p>
    <motion.p variants={fu(.8)} className="sub" style={{fontWeight:700,color:'var(--white)',marginTop:0}}>• Funding Institutions</motion.p>
  </motion.div>
</motion.div></div></div>);}

/* SLIDE 48 — TikTok / IG Reels (no changes) */
...
/* SLIDE 49 — SA Film Academy (CORRECTED: image replaced with safa-1.jpg, dark overlays) */
function S49({a}:P){if(!a)return null;return(<div className="slide"><BG src="/safa-1.jpg"/><div className="ov ov--r"/><div className="ov ov--v"/><div className="ov ov--d"/>
<div className="cnt cnt--right"><motion.div initial="hidden" animate="visible">
...
/* SLIDE 50 — Which Lane Appeals Most? (CORRECTED: image replaced with safa-2.jpg, EmpowaYouth spelling) */
function S50({a}:P){if(!a)return null;return(<div className="slide"><BG src="/safa-2.jpg" alt/><div className="ov ov--d"/><div className="ov ov--v"/>
<div className="cnt cnt--center" style={{textAlign:'center'}}><motion.div initial="hidden" animate="visible">
  ...
  <motion.p variants={fu(1.2)} style={{marginTop:'2rem',fontSize:'1.2rem',color:'var(--gray-300)'}}>SA Film Academy • EmpowaYouth 2026</motion.p>
</motion.div></div></div>);}

/* SLIDE Q&A — Final Slide */
function SQA({a}:P){if(!a)return null;return(<div className="slide"><BG src="/qa-slide.png"/><div className="ov ov--d"/><div className="ov ov--v"/>
<div className="cnt cnt--center" style={{textAlign:'center'}}><motion.div initial="hidden" animate="visible">
  <h2 className="ttl ttl--hero" style={{fontSize:'clamp(5rem,10vw,10rem)'}}><span className="accent"><W t="Q & A"/></span></h2>
  <motion.div variants={fu(.7)} style={{width:'80px',height:'3px',background:'linear-gradient(90deg, transparent, var(--accent), transparent)',margin:'1.5rem auto'}}/>
  <motion.p variants={fu(.8)} className="sub" style={{margin:'1.5rem auto',textAlign:'center',maxWidth:'600px',fontSize:'1.3rem'}}>SA Film Academy • Vaal EmpowaYouth Week 2026</motion.p>
</motion.div></div></div>);}

/* ========== MAIN ========== */
/* S5 deleted; SQA added. Total: 50 slides */
const SL=[S1,S2,S3,S4,S6,S7,S8,S9,S10,S11,S12,S13,S14,S15,S16,S17,S18,S19,S20,S21,S22,S23,S24,S25,S26,S27,S28,S29,S30,S31,S32,S33,S34,S35,S36,S37,S38,S39,S40,S41,S42,S43,S44,S45,S46,S47,S48,S49,S50,SQA];

/* ========== MAP DATA (renumbered after S5 deletion + Q&A addition) ========== */
const M = [
  { s: "Context", i:0, slides: [ {i:0, t:"EmpowaYouth"}, {i:1, t:"Africa Summit"}, {i:2, t:"Dynamics"}, {i:3, t:"AI & Platforms"}, {i:4, t:"Potential"} ]},
  { s: "Skills", i:5, slides: [ {i:5, t:"Breaking In"}, {i:6, t:"Production"}, {i:7, t:"Writing"}, {i:8, t:"Sound"}, {i:9, t:"Art Dept"}, {i:10, t:"Post-Prod"} ]},
  { s: "Story", i:11, slides: [ {i:11, t:"Visuals"}, {i:12, t:"Structure"}, {i:13, t:"Observation"} ]},
  { s: "Soft Skills", i:14, slides: [ {i:14, t:"Reliability"}, {i:15, t:"Collab"}, {i:16, t:"Comm"}, {i:17, t:"Resilience"}, {i:18, t:"Problem Solving"} ]},
  { s: "Industry", i:19, slides: [ {i:19, t:"Roles"}, {i:20, t:"Workflow"}, {i:21, t:"SA Context"}, {i:22, t:"Safety"} ]},
  { s: "Toolkit", i:23, slides: [ {i:23, t:"Courses"}, {i:24, t:"Run on Set"}, {i:25, t:"Make Stuff"}, {i:26, t:"Network"}, {i:27, t:"Software"}, {i:28, t:"Entry Points"} ]},
  { s: "Experience", i:29, slides: [ {i:29, t:"What Hires"}, {i:30, t:"Comparison"}, {i:31, t:"No Certs"}, {i:32, t:"Apprentice"}, {i:33, t:"Training"} ]},
  { s: "Jobs", i:34, slides: [ {i:34, t:"Entry Jobs"}, {i:35, t:"Runner"}, {i:36, t:"Cam Trainee"}, {i:37, t:"Art Assist"}, {i:38, t:"Trust"}, {i:39, t:"Rehire"}, {i:40, t:"Don't Just Study"} ]},
  { s: "Access", i:41, slides: [ {i:41, t:"Bottom Line"}, {i:42, t:"No Barriers"}, {i:43, t:"Phones"}, {i:44, t:"48-Hour"}, {i:45, t:"Funding"}, {i:46, t:"Social Media"}, {i:47, t:"SA Academy"}, {i:48, t:"Next Move"}, {i:49, t:"Q&A"} ]}
];
